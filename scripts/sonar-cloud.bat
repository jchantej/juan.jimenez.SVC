@echo off
set workspace=C:\Users\Chante\Documents\ProyectosEclipce\juan.jimenez.SVC
...
call mvn sonar:sonar -Dsonar.organization=jchantej-github -Dsonar.host.url=https://sonarcloud.io -Dsonar.login=2ecd7ab215fdd4059c6f40f9bc5bb76b6d784163 --settings settings.xml
pause
